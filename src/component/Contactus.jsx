...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css"></link>
 ...
 <div> <i data-aos="fade-down" style={{fontSize:"60px"}} class="bi bi-envelope"></i></div>
  ...
  <textarea   value={message} onChange={(e)=> setMessage(e.target.value)} style={{width:"770px",height:"200px"}} class="form-control" placeholder='Message' required id="exampleFormControlTextarea1" rows="3"></textarea>
</div>
        </div>
        <div className='col-3'></div>
  ...
  <button  style={{width:"130px" , color:"white", backgroundColor:"green"}}class="btn " type="submit">SEND </button>
        </div>
        <div className='col-3'></div>
        <div className='col-3'></div>
